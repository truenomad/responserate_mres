...
text(-6.70, 10.4, "Author(s) and Year", cex=1.0, font=2, pos=4)
text(10.2, 10.4, "Weighted Response Rate Difference [95% CI]", font=2, cex=1.0, pos=2)

### add text with Q-value, dfs, p-value, and I^2 statistic
text(-6.7, -0.8, pos=4, cex=0.90, bquote(paste("RE Model for All Studies",
                                         ", df = ", .(rem$k - rem$p),
